...
static volatile u16 m_nSoftCount[ecoINVALID];
volatile u32 sys_msec;
...
{
	m_nSoftCount[eTimer] = nValue;
}
//----------------------------------
void Delay10ms(u16 nTick)
{
	m_nSoftCount[ecoDELAY] = nTick;
	while(m_nSoftCount[ecoDELAY])
		__WFI();
}
...
//-------------------------------------
// transfer complete by ADC1 capture buffer done
//--------------------------------------
void DMA1_Channel1_IRQHandler(void)
{
	//extern u16 m_adcBuf[][];
	extern u8 m_adcGoingIdx;

	DMA_ClearITPendingBit(DMA1_IT_TC1);
	m_adcGoingIdx = (m_adcGoingIdx) ? 0 : 1;
}
